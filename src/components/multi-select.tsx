    ...
    return (
      ...
      >
            ...
            {selected.map((option) => {
              return (
                ...
                >
                  ...
                  >
                    {option.label}
                    <X className="h-3 w-3 text-primary-foreground hover:text-foreground ml-2" />
                  </Badge>
                </button>
              );
            })}
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute top-1 z-10 w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none"
              onMouseLeave={() => {
